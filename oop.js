...
let age = 33 >= 17 ? "punya KTP" : "belom punya KTP"
console.log(age)
...
console.log(objUser5) //{ name:"aries dimas", age:33}
console.log(objUser5b) // { name:"aries dimas", age:33}

// constructor adalah method yg akan di eksekusi kalau object baru di buat 
